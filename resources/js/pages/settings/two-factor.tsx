...
import { ShieldBan, ShieldCheck, ShieldQuestion, Smartphone } from 'lucide-react';
        ...
        <>
            ...
            >
                <PageHero
                    ...
                    description="Add an extra verification step to protect your account and keep your builds secure."
                    backHref="/account"
                    backLabel="Back to Account"
                    aside={
                        <StatusBadge variant={twoFactorEnabled ? 'success' : 'danger'}>
                            {twoFactorEnabled ? (
                ...
                <section className="mt-6 grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
                    <article className="rounded-3xl border border-white/10 bg-[#08101c]/85 p-6 sm:p-7">
                        {twoFactorEnabled ? (
                            ...
                            <div className="space-y-5">
                                <p className="text-sm text-slate-300 sm:text-base">
                                    Enable two-factor authentication to require a
                                    six-digit code from your authenticator app during
                                    login.
                                </p>
                                ...
                                <div className="rounded-2xl border border-white/10 bg-[#0a1322] p-4">
                                    <ul className="space-y-2 text-sm text-slate-300">
                                        ...
                                        <li>2. Confirm with a one-time code.</li>
                                        <li>
                                            3. Save your recovery codes in a safe
                                            place.
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <article className="rounded-3xl border border-white/10 bg-[#08101c]/85 p-6 sm:p-7">
                        ...
                        <ul className="mt-4 space-y-3 text-sm text-slate-300">
                            <li>
                                Use Google Authenticator, Authy, or 1Password as
                                your TOTP app.
                            </li>
                            <li>
                                Keep recovery codes outside your browser and cloud
                                notes.
                            </li>
                            <li>
                                If you change phone, reconfigure 2FA immediately.
                            </li>
                        </ul>
                    </article>
                </section>
