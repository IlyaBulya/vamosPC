                        ...
                        >
                            ...
                            >
                                ...
                                <img
                                    ...
                                    decoding="async"
                                    draggable={false}
                                    className="absolute -top-[2%] -right-[15%] h-auto w-[150%] max-w-none object-contain opacity-65 drop-shadow-[0_0_42px_rgba(0,189,125,0.3)] saturate-125 min-[360px]:w-[135%] sm:-right-[8%] sm:w-[110%] md:top-[10%] md:-right-[24%] md:h-[84%] md:w-auto md:opacity-55 lg:-top-12 lg:-right-16 lg:bottom-auto lg:h-[min(104dvh,66vw,70rem)] lg:-translate-y-[11%] lg:opacity-100 lg:drop-shadow-[0_32px_70px_rgba(0,0,0,0.55)] lg:saturate-100 xl:h-[min(116dvh,72vw,82rem)]"
                                />

                                <div className="absolute inset-0 bg-[linear-gradient(90deg,#030712_0%,rgba(3,7,18,0.96)_38%,rgba(3,7,18,0.16)_100%)] lg:hidden" />
                                <div className="absolute inset-0 bg-[linear-gradient(180deg,transparent_86%,#030712_100%)] md:bg-[linear-gradient(180deg,transparent_72%,#030712_100%)] lg:hidden" />
                            </figure>
                        </section>
